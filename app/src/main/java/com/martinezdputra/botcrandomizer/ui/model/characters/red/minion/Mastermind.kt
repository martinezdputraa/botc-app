...
class Mastermind : MinionCharacter() {
    override val character: Characters
        get() = Characters.MASTERMIND

    override val nameResId: Int
        get() = R.string.character_mastermind_name

    override val descriptionResId: Int
        get() = R.string.character_mastermind_description

    override val imageResId: Int
        get() = R.drawable.ic_mastermind
}