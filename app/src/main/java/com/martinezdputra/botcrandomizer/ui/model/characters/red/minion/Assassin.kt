...
class Assassin : MinionCharacter() {
    override val character: Characters
        get() = Characters.ASSASSIN

    override val nameResId: Int
        get() = R.string.character_assassin_name

    override val descriptionResId: Int
        get() = R.string.character_assassin_description

    override val imageResId: Int
        get() = R.drawable.ic_assassin
}