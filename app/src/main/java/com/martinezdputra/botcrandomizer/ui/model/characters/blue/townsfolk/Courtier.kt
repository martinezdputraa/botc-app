...
class Courtier : TownsfolkCharacter() {
    override val character: Characters
        get() = Characters.COURTIER

    override val nameResId: Int
        get() = R.string.character_courtier_name

    override val descriptionResId: Int
        get() = R.string.character_courtier_description

    override val imageResId: Int
        get() = R.drawable.ic_courtier
}