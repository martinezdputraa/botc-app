...
class EvilTwin : MinionCharacter() {
    override val character: Characters
        get() = Characters.EVIL_TWIN

    override val nameResId: Int
        get() = R.string.character_evil_twin_name

    override val descriptionResId: Int
        get() = R.string.character_evil_twin_description

    override val imageResId: Int
        get() = R.drawable.ic_evil_twin
}