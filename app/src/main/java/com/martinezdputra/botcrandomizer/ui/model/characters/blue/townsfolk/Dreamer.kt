...
class Dreamer : TownsfolkCharacter() {
    override val character: Characters
        get() = Characters.DREAMER

    override val nameResId: Int
        get() = R.string.character_dreamer_name

    override val descriptionResId: Int
        get() = R.string.character_dreamer_description

    override val imageResId: Int
        get() = R.drawable.ic_dreamer
}